...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="union_">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="regimen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="166,182,228,255"/>
  ...
  <aliases>
    ...
    <alias field="union_" index="1" name=""/>
    <alias field="tipo" index="2" name=""/>
    <alias field="nombre" index="3" name=""/>
    <alias field="regimen" index="4" name=""/>
    <alias field="navegabili" index="5" name=""/>
    <alias field="provincia" index="6" name=""/>
    <alias field="pais" index="7" name=""/>
    <alias field="observacio" index="8" name=""/>
    <alias field="hoja" index="9" name=""/>
